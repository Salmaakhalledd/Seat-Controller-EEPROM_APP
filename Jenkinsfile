        ...
        stage('Build') {
            steps {
                bat '''
                    ...
                    javac -cp Seat-Controller-EEPROM_APP\\lib\\jSerialComm-2.11.2.jar -d out @sources.txt
        ...
        stage('Test') {
            steps {
                bat '''
                    ...
                    javac -cp "Seat-Controller-EEPROM_APP\\lib\\jSerialComm-2.11.2.jar;Seat-Controller-EEPROM_APP\\lib\\junit-4.13.2.jar;Seat-Controller-EEPROM_APP\\lib\\hamcrest-core-1.3.jar;out" -d out @test-sources.txt
